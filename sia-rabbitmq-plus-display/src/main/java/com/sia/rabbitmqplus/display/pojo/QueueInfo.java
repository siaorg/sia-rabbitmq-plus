package com.sia.rabbitmqplus.display.pojo;
...
public class QueueInfo implements java.io.Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 201709141140L;
     ...
     * 给队列发送的IP地址
     */
    private Map<String, String> publishIps = new TreeMap<String, String>();

    /**
     * 从队列接收的IP地址
     */
    private Map<String, String> deliverIps = new TreeMap<String, String>();
