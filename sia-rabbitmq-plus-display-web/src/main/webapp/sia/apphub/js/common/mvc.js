 ...
 * MCV loader
 */
function AppHubMVCLoader() {
	
	var str="<div id=\"AppHubMVCLoad\" class=\"AppHubMVCLoading\">加载中...</div>";
	
	document.body.innerHTML+=str;
	
	this.show=function() {
		HtmlHelper.css("AppHubMVCLoad",{display:"block"});
	};
	
	this.hide=function() {
		HtmlHelper.css("AppHubMVCLoad",{display:"none"});
	};
}
/**
 * search bar
