...
heartbeat_yml="heartbeat_application.yml"
...
java $javaOpts -XX:OnOutOfMemoryError='kill -9 %p'  -Dspring.config.location=../config/$heartbeat_yml  -jar  $working_directory/$2 &
