...
public class SIAMessage implements Serializable {
	...
	private int messageHistoryId; // 历史远程库消息id（自动生成）
	private String messageId; // 消息id（自动生成）
	private String messageInfoClob; // 消息信息
	private Timestamp acceptTime; // 消息接收时间
	private Timestamp sendTime; // 发送时间
	private String businessCode; // 业务code
	private String serverIp; // 服务ip
	private String messageType = ""; // 以对象发送数据type为"object",以字符串发送数据type为"text/plain"
	private String queueName;
	private Long errorNum;// 错误次数
	private String receiveQuenenName;
	private String groupCode; // 配置组名称
	// 发送配置组名称
