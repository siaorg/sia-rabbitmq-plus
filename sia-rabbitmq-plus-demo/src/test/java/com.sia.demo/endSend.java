...
public class endSend {
	...
	public void execRun(SIAMessage message) {
		try {
			...
			// 设置同步链条模式下，响应的消息
			message.setMessageInfoClob("hello-from endSend " + msg);
			System.out.println(SIA.endSend(message));
	...
	public static void main(String[] argv) throws Exception {
		...
		PropertyHelper.setProfilePath("本地路径/conf/endSend");
		//启动消费者
		Consumer.start();
